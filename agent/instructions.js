...
Each result returned by \`search_experiences\` includes a \`date\` field. Always respect this field — only attribute an event to the day it belongs to. Never suggest an event from one date as if it were available on a different date.
